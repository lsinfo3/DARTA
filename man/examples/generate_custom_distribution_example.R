...
vec <- generate_custom_distribution(n = 1e6, name = paste("hypergeometric", n, sep = "-"), cdf = cdf, inv = inv, mean = mean, var = var, m = m, k = k, rho=rho, method = "interpol", use_caching = F)
